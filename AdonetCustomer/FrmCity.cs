...
namespace AdonetCustomer
{
    public partial class FrmCity : Form
    {
        ...
        SqlConnection sqlConnection = new SqlConnection("Server=YAKUP-BINGOL;initial catalog=DbCustomer;" +
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            sqlConnection.Close();
            MessageBox.Show("Sehir basarili sekilde eklendi");
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            command.ExecuteNonQuery();
            sqlConnection.Close();
            MessageBox.Show("Sehir basariyla silindi", "Uyari!", MessageBoxButtons.OK,
